...
public class Http11ServiceChainTestCase extends TestCase {
	
	private HttpServer server;
	
	private File tmpDir;
	
    public Http11ServiceChainTestCase() {
		super();
	}

	public Http11ServiceChainTestCase(String name) {
		super(name);
	}
	...
	public void testHttpServiceChain1() throws Exception {
	...
	public void testHttpServiceChain2() throws Exception {
	...
	public static Test suite() {
		return new TestSuite(Http11ServiceChainTestCase.class);
	}
