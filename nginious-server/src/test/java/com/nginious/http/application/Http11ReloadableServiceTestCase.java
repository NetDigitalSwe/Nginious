...
public class Http11ReloadableServiceTestCase extends TestCase {
    ...
    public Http11ReloadableServiceTestCase() {
		super();
	}

	public Http11ReloadableServiceTestCase(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		...
		this.destFile = new File(this.tmpDir, "test/WEB-INF/classes/com/nginious/http/loader/ReloadTestService.class");
		FileUtils.copyFile("build/classes/testload1/classes/com/nginious/http/loader/ReloadTestService.class", destFile.getAbsolutePath());
	...
	public void testReloadableHttpService() throws Exception {
		...
		Thread.sleep(1000L);
		FileUtils.copyFile("build/classes/testload2/classes/com/nginious/http/loader/ReloadTestService.class", destFile.getAbsolutePath());
		...
		this.destFile = new File(this.tmpDir, "test/WEB-INF/classes/com/nginious/http/loader/ReloadTestService2.class");
		FileUtils.copyFile("build/classes/testload1/classes/com/nginious/http/loader/ReloadTestService2.class", destFile.getAbsolutePath());
		
		expectedResponse = "HTTP/1.1 200 OK\015\012" +
				"Content-Type: text/plain; charset=utf-8\015\012" +
				"Date: <date>\015\012" + 
				"Content-Length: 21\015\012" +
				"Connection: close\015\012" +
				"Server: Nginious/1.0.0\015\012\015\012" +
				"ReloadTestService2 1\n";
		...
		Thread.sleep(1000L);
		FileUtils.copyFile("build/classes/testload2/classes/com/nginious/http/loader/ReloadTestService2.class", destFile.getAbsolutePath());
	...
	public static Test suite() {
		return new TestSuite(Http11ReloadableServiceTestCase.class);
	}
