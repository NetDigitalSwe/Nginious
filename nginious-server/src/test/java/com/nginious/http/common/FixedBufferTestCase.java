...
public class FixedBufferTestCase extends TestCase {
	
	public FixedBufferTestCase() {
		super();
	}

	public FixedBufferTestCase(String name) {
		super(name);
	}
	...
	public void testData() throws Exception {
		for(int i = 1; i <= 131072; i *= 2) {
			...
			for(int j = 1; j < 8192; j *= 2) {
				int parts = (int)(i / j);
				FixedBuffer buffer = new FixedBuffer(2097152);
	...
	public void testGeneral() throws Exception {
		FixedBuffer buffer = new FixedBuffer(1000);
		
		// Test fill upp buffer
    ...
    public static Test suite() {
		return new TestSuite(FixedBufferTestCase.class);
	}
