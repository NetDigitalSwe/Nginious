...
public class XmlSerializerTestCase extends XMLTestCase {
	...
	public void testXmlSerializer() throws Exception {
		...
		Serializer<SerializableBean> serializer = SerializerFactory.getInstance().createSerializer(SerializableBean.class, "text/xml, application/json; q=0.9");
	...
	public void testEmptyXmlSerializer() throws Exception {
		SerializableBean bean = new SerializableBean();
		Serializer<SerializableBean> serializer = SerializerFactory.getInstance().createSerializer(SerializableBean.class, "text/xml");
		assertEquals("text/xml", serializer.getMimeType());
