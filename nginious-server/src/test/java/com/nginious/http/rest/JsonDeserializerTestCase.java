...
public class JsonDeserializerTestCase extends TestCase {
	...
	public void testJsonDeserialization() throws Exception {
		...
		Deserializer<SerializableBean> deserializer = DeserializerFactory.getInstance().createDeserializer(SerializableBean.class, "application/json");
	...
	public void testInvalidContentTypeDeserialization() throws Exception {
		...
		Deserializer<SerializableBean> deserializer = DeserializerFactory.getInstance().createDeserializer(SerializableBean.class, "text/nonexistent");
	...
	public void testJsonDeserializationAnnotations() throws Exception {
		...
		Deserializer<JsonAnnotatedBean> deserializer = DeserializerFactory.getInstance().createDeserializer(JsonAnnotatedBean.class, "application/json");
		assertEquals("application/json", deserializer.getMimeType());
	...
	public void testJsonDeserializationFactory() throws Exception {
		...
		Deserializer<InBean> deserializer = DeserializerFactory.getInstance().createDeserializer(InBean.class, "application/json");
		Deserializer<InBean> deserializer2 = DeserializerFactory.getInstance().createDeserializer(InBean.class, "application/json");
		...
		try {
			DeserializerFactory.getInstance().createDeserializer(NotAnnotatedBean.class, "application/json");
		...
		try {
			DeserializerFactory.getInstance().createDeserializer(NotDeserializableBean.class, "application/json");
			fail("Must not be possible to create deserializer for bean where deserialize = false");
		} catch(SerializerFactoryException e) {}

		try {
			DeserializerFactory.getInstance().createDeserializer(NotJsonBean.class, "application/json");
