...
public class Suite extends TestSuite {
    ...
    public static Test suite() {
    	...
    	suite.addTest(new RestServiceSerializationTestCase("testRestServiceSerialization"));
    	suite.addTest(new RestServiceSerializationTestCase("testMissingContentTypeSerialization"));
    	suite.addTest(new RestServiceSerializationTestCase("testInvalidContentTypeSerialization"));
    	suite.addTest(new RestServiceSerializationTestCase("testMissingAcceptSerialization"));
    	suite.addTest(new RestServiceSerializationTestCase("testInvalidAcceptSerialization"));
    	suite.addTest(new RestServiceSerializationTestCase("testVoidServiceSerialization"));
