...
public class SerializationClassLoaderTestCase extends XMLTestCase {
	...
	public void testSerialization() throws Exception {
		...
		contextLoader.loadClass("com.nginious.http.serialize.InBean");
		contextLoader.loadClass("com.nginious.http.serialize.InBean");
		
		ApplicationClassLoader loader = new ApplicationClassLoader(contextLoader, webappDir);
		
		Class<?> serviceClazz = loader.loadClass("com.nginious.http.loader.TestController");
		serviceClazz = loader.loadClass("com.nginious.http.loader.TestController");
		serviceClazz = loader.loadClass("com.nginious.http.loader.TestController");
		ControllerServiceFactory factory = new ControllerServiceFactory(loader);
		...
		invoke = factory.createControllerService(service);
