...
@Controller(path = "/wsserialize")
public class TestWebSocketSerializeController {
	
	public TestWebSocketSerializeController() {
		super();
	}
	...
	@Message(operations = { WebSocketOperation.TEXT }, contentType = "application/json")
	public TestBean1 executeTextMessage(TestBean1 bean, WebSocketTextMessage message, WebSocketSession session) throws WebSocketException, IOException {
		return bean;
	}
