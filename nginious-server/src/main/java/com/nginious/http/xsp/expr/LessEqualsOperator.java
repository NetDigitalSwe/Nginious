...
/**
 * A comparison operator which checks if the left side argument value is less than or equals to
...
public class LessEqualsOperator extends ComparisonOperator {
	...
	/**
	 * Constructs a new less than or equals operator with the specified two argument values.
	 * 
	 ...
	 */
    public LessEqualsOperator(Value value1, Value value2) throws ExpressionException {
    	super(value1, value2);
    	
    	if(value1.getType() == Type.STRING || value2.getType() == Type.STRING) {
    		throw new ExpressionException("Can't use less than or equals operator with strings");
    	}
    }

    /**
     * Evaluates this less than or equals operator.
     * 
     * @return <code>true</code> if the left side argument value is less than or equals
