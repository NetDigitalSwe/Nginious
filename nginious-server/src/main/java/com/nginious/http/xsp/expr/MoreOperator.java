...
/**
 * A comparison operator which checks if the left side argument value is greater than
 * the right side argument value.
 * 
 * @author Bojan Pisler, NetDigital Sweden AB
 *
 */
public class MoreOperator extends ComparisonOperator {
    ...
    /**
     * Evaluates this more operator.
     * 
     * @return <code>true</code> if the left side argument value is greater than the
