...
/**
 * A comparison operator which checks if the left side argument value is less than
...
public class LessOperator extends ComparisonOperator {
	...
	/**
	 * Constructs a new less operator with the specified two argument values.
	 * 
	 ...
	 */
    public LessOperator(Value value1, Value value2) throws ExpressionException {
    	super(value1, value2);
    	
    	if(value1.getType() == Type.STRING || value2.getType() == Type.STRING) {
    		throw new ExpressionException("Can't use less than operator with strings");
    	}
    }

    /**
     * Evaluates this less operator.
     * 
