...
/**
 * A math function which returns the lowest of two value argumrnyd. Below is an example which 
 * evaluates to 4.
 * 
 * <pre>
 * min(4, 6)
...
public class MinFunction extends Function {
    ...
    /**
     * Constructs a new min function which returns the smallest of the two specified
     * values.
     * 
     * @param value1 the first value
     * @param value2 the second value
     */
    public MinFunction(Value value1, Value value2) {
        super();
        this.value1 = value1;
        this.value2 = value2;
    }
    ...
    /**
     * Evaluates this function which returns the lowest of the two argument values.
     * 
	...
	protected Value evaluate() {
    	...
    	switch(type) {
    	case DOUBLE:
    		returnValue = new DoubleValue(Math.min(value1.getDoubleValue(), value2.getDoubleValue()));
    		break;
    		
    	case INT:
    		returnValue = new IntegerValue(Math.min(value1.getIntValue(), value2.getIntValue()));
    		break;
    	}
    ...
    /**
     * Evaluates this function and returns the lowest value as an integer.
     * 
     * @return the integer result of evaluating this function
     */
    protected int getIntValue() {
    	return Math.min(value1.getIntValue(), value2.getIntValue());
    }
    
    /**
     * Evaluates this function and returns the lowest value as a double.
     * 
    ...
    /**
     * Evaluates this function and returns the lowest value converted to a string.
     * 
	...
	protected String getStringValue() {
    	...
    	case INT:
    		value = Integer.toString(Math.min(value1.getIntValue(), value2.getIntValue()));
    		break;
    	}
    ...
    /**
     * Evaluates this function and returns the lowest value converted to a boolean.
     * 
     * @return <code>true</code> if the lowest value is different from 0.0d, <code>false</code>
     * 	otherwise
     */
    ...
    void compile(MethodVisitor visitor, Type type) {
    	...
    	visitor.visitMethodInsn(Opcodes.INVOKESTATIC, "java/lang/Math", "min", type == Type.DOUBLE ? "(DD)D" : "(II)I");
    }
}
