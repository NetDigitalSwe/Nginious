...
/**
 * A REST controller for deploying, redeploying, removing and getting information about a web application.
...
public class ApplicationController {
	...
	ApplicationController(ApplicationManagerImpl manager) {
	...
	public ApplicationInfo executeGet(HttpRequest request, HttpResponse response) throws HttpException, IOException {
	...
	public ApplicationInfo executePost(HttpRequest request, HttpResponse response) throws HttpException, IOException {
		try {
			PathParameters params = new PathParameters(request);
			String name = params.get(2);
	...
	public ApplicationInfo executePut(HttpRequest request, HttpResponse response) throws HttpException, IOException {
		try {
			PathParameters params = new PathParameters(request);
			String name = params.get(2);
	...
	public ApplicationInfo executeDelete(HttpRequest request, HttpResponse response) throws HttpException, IOException {
		try {
			PathParameters params = new PathParameters(request);
			String name = params.get(2);
