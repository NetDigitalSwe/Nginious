...
public class DeserializerFactory {
	...
	private static DeserializerFactory factory = null;
	...
	/**
	 * Constructs a new deserializer factory.
	 */
	private DeserializerFactory() {
		super();
		this.xmlCreator = new XmlDeserializerCreator();
		this.jsonCreator = new JsonDeserializerCreator();
		this.queryCreator = new QueryDeserializerCreator();
	}
	
	/**
	 * Returns the deserializer factory.
	 * 
