...
@Service(path="/reload2")
public class ReloadTestService2 extends HttpService {
	...
	public HttpServiceResult executeGet(HttpRequest request, HttpResponse response) throws HttpException, IOException {
		...
		response.setContentLength("ReloadTestService2 1\n".getBytes().length);
		PrintWriter writer = response.getWriter();
		writer.println("ReloadTestService2 1");
